...
const BookingProccessing = lazy(() =>
	import("../src/route/adminPages/bookingProcessing")
);
...
const CustomerBook = lazy(() =>
	import("../src/route/customerPages/customerBook")
);
const Loginform = lazy(() => import("../src/route/authPages/login"));
const HomeComponent = lazy(() =>
	import("../src/route/adminPages/homeComponent")
);
const CarOwnerRoute = lazy(() =>
	import("../src/route/customerPages/ownersRoute")
);
const CreateAccount = lazy(() =>
	import("../src/route/authPages/createAccount")
);
...
function App() {
	const [neww, setNeww] = useState({
		count: 0,
		call: function () {
			return personalisedNotification;
		},
	});
