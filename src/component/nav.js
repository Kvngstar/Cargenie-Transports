...
const Nav__ = () => {
    return ( 
        ...
        <Link to="login"> <span className='ml-3 whitetext  robotomeduim btn'>Login</span></Link>
        <Link to="signup"><span className='ml-3 whitetext robotomeduim btn'>Sign-up</span></Link>
